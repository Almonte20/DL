        ...
        <div class="row ">
            <div class="col-md-12 text-center">
                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="conozcoResponsableS" name="conozcoResponsable" class="custom-control-input"
                        value="1" onchange="conozco_responsable()">
                    <label class="custom-control-label" for="conozcoResponsableS">Sí </label>
                </div>
                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="conozcoResponsableN" name="conozcoResponsable" class="custom-control-input"
                        value="0" onchange="conozco_responsable()">
