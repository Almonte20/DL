<style media="screen">
    ...
    @section('titulo','Modificación de denuncia')
    ...
    <div class="container">
      ...
      <h5>Formulario de modificación</h5>
      <hr>
      <blockquote>
        <p class="text-justify font-weight-light">Módulo de modificación de denuncia.</p>
      </blockquote>
      <!-- tabs -->
      @if(session()->has('fail'))
      ...
      <form action="{{ route('denuncia.editarDenuncia') }}" method="POST">
