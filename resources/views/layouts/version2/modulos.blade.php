                ...
                <div class="col-lg-12" id="header1">
                    ...
                    <nav id="nav-menu-container">
                            ...
                            <ul class="nav-menu">
                                ...
                                <li class="menu-has-children nav-menu-item"><a href="{{ url('#informacion') }}">Consulta</a>
                                    <ul>
                                        <li><a href="https://juridico.fiscaliamichoacan.gob.mx/plataformanormativa/" target="_blank"><img src="{{ asset('img/iconos/plataforma_virtual_narrativa_b.png/') }}" height="30px">&nbsp&nbspPlataforma Virtual Normativa</a></li>
                                        <li><a href="{{ url('/acuerdos') }}"  target="_blank"><img src="{{ asset('img/iconos/acuerdos.png/') }}"height="30px">&nbsp&nbspAcuerdos</a></li>
                                        ...
                                        <li><a href="{{ asset('/documentos/codigo_nacional/Código Nacional de Procedimientos Penales.pdf')}}" target="_blank"><img src="{{ asset('img/iconos/nacional_penal.png/') }}" height="30px">&nbsp&nbspCódigo Nacional de Procedimientos Penales</a></li>
                                ...
                                <li class="menu-has-children nav-menu-item"><a href="{{ url('#informacion') }}">Alerta</a>
                                    <ul>
                                ...
                                <li class="menu-has-children nav-menu-item"><a href="{{ url('/descargas') }}" target="_blank">Descargas</a></li>
                                ...
                                <li class="nav-menu-item" style="float: right;"><a href="https://www.facebook.com/FiscaliaMich/" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                                <li class="nav-menu-item" style="float: right;"><a href="https://twitter.com/FiscaliaMich?lang=es" target="_blank"><i class="fab fa-twitter"></i></a></li>
      ...
      <div class="container-fluid bottom">
          <div class="row">
              ...
              <div class="col-lg-2 col-xs-12 text-lg-center text-sm-center text-center list-inline">
                  ...
                  <a href="https://www.facebook.com/FiscaliaMich/" target="_blank"><i class="fab fa-facebook-square"></i>&nbsp&nbspFacebook</a>
                  <a href="https://twitter.com/FiscaliaMich" target="_blank"><i class="fab fa-twitter-square"></i>&nbsp&nbspTwitter</a>
              </div>
          </div><br>
          <hr>
          <div class="row copyright">
              <div class="col-lg-12 text-lg-center text-sm-center text-center">
                  ...
                  <a href="#" style="float: right; margin-right: 30px;">Versión Beta 0.9</a>
              </div>
          </div>
