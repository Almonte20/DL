...
<div class="top-content">
    ...
    <div class="container" style = "font-weight: bold; color: Black;">
        <div class="col-lg-12 text-left ">
            <img src="{{ asset('img/PDF_Predenuncia/logo_predenuncia.png') }}" height="80" width="300"><br>
        </div>
                    ...
                    <fieldset>
                        ...
                        <div class="form-row col-lg-12">
                            <div class="form-group col-md-4">
                                ...
                                {!! Form::text('nombre', '', ['class' => 'form-control','value' => "{{ old('nombre') }}" ,'required' => 'true','maxlength'=> '50', 'style' => 'background-color:rgba(230, 238, 250, 0.5);']) !!}
                            ...
                            <div class="form-group col-md-4">
                                ...
                                {!! Form::text('PrimerApellido', '', ['class' => 'form-control','value' => "{{ old('PrimerApellido') }}" ,'maxlength'=> '50', 'style' => 'background-color:rgba(230, 238, 250, 0.5);']) !!}
                                <div style="color:#FF0000;">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                {!! Form::text('SegundoApellido', '', ['class' => 'form-control', 'value' => "{{ old('SegundoApellido') }}" ,'maxlength'=> '50','style' => 'background-color:rgba(230, 238, 250, 0.5);']) !!}
                                <div style="color:#FF0000;">
                        ...
                        <div class="form-row col-lg-12">
                            <div class="form-group col-md-4">
                                ...
                                {!! Form::text('curp', '', ['class' => 'form-control', 'value' => "{{ old('curp') }}" ,'maxlength'=> '18','style' => 'background-color:rgba(230, 238, 250, 0.5);']) !!}
                                <div style="color:#FF0000;">
                                    {{ $errors->first('curp') }}
                                </div>
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                {!! Form::email('correo', '', ['class' => 'form-control', 'value' => "{{ old('correo') }}" ,'maxlength'=> '50','placeholder' => 'example@dominio.com','style' => 'background-color:rgba(230, 238, 250, 0.5);']) !!}
                                <div style="color:#FF0000;">
                                    {{ $errors->first('correo') }}
                                </div>
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                {!! Form::text('telefono', '', ['class' => 'form-control','value' => "{{ old('telefono') }}" ,'maxlength'=> '10','onkeypress'=>'return justNumbers(event);','style' => 'background-color:rgba(230, 238, 250, 0.5);']) !!}
                                <div style="color:#FF0000;">
                        ...
                        <div class="form-row col-lg-12">
                            <div class="form-group col-md-4">
                                ...
                                {!! Form::select('pais',$paises,0, ['class' => 'form-control','value' => "{{ old('pais') }}" ,'placeholder' => 'Seleccione una opcion', 'style' => 'background-color:rgba(230, 238, 250, 0.5);',]) !!}
                                <div style="color:#FF0000;">
                                    {{ $errors->first('pais') }}
                                </div>
                            </div>
                            <div class="form-group col-md-8" id = "extranjero" style="display: none">
                                ...
                                {!! Form::text('domicilio_extranjero', '', ['class' => 'form-control', 'value' => "{{ old('domicilio_extranjero') }}" ,'maxlength'=> '255','placeholder' => 'Ciudad Extrajera','style' => 'background-color:rgba(230, 238, 250, 0.5);']); !!}
                                <div style="color:#FF0000;">
                        ...
                        <div class="form-row col-lg-12">
                            <div class="form-group col-md-4">
                                ...
                                {!! Form::select('entidad',$estados, 0, ['class' => 'form-control','value' => "{{ old('entidad') }}" ,'placeholder' => 'Seleccione una opcion', 'style' => 'background-color:rgba(230, 238, 250, 0.5);']) !!}
                                <div style="color:#FF0000;">
                                    {{ $errors->first('entidad') }}
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="display: none">
                                {!! Form::text('pivote_municipio','', ['class' => 'form-control','id' => 'pivote_municipio']); !!}
                            </div>
                            <div class="form-group col-md-4">
                                <div class="form-ic-cmp">
                                ...
                                {!! Form::select('municipio', array(), 0, ['class' => 'form-control', 'value' => "{{ old('municipio') }}" ,'placeholder' => 'Seleccione un estado primero', 'style' => 'background-color:rgba(230, 238, 250, 0.5);']) !!}
                                <div style="color:#FF0000;">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                {!! Form::text('calle',  '', ['class' => 'form-control',  'value' => "{{ old('calle') }}" ,'maxlength'=> '100','style' => 'background-color:rgba(230, 238, 250, 0.5);']) !!}
                                <div style="color:#FF0000;">
                                    {{ $errors->first('calle') }}
                                </div>
                            </div>
                        ...
                        <div class="form-row col-lg-12">
                            <div class="form-group col-md-4">
                                ...
                                {!! Form::text('colonia',  '', ['class' => 'form-control',  'value' => "{{ old('colonia') }}" ,'maxlength'=> '25','style' => 'background-color:rgba(230, 238, 250, 0.5);']) !!}
                                <div style="color:#FF0000;">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                {!! Form::text('numext',  '', ['class' => 'form-control',  'value' => "{{ old('numext') }}" ,'maxlength'=> '6','style' => 'background-color:rgba(230, 238, 250, 0.5);']) !!}
                                <div style="color:#FF0000;">
                                    {{ $errors->first('numext') }}
                                </div>
                            </div>
                            <div class="form-group col-md-2">
                                ...
                                {!! Form::text('numint',  '', ['class' => 'form-control', 'value' => "{{ old('numint') }}" ,'maxlength'=> '6','style' => 'background-color:rgba(230, 238, 250, 0.5);']) !!}
                                <div style="color:#FF0000;">
                                    {{ $errors->first('numint') }}
                                </div>
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                {!! Form::text('CP',  '', ['class' => 'form-control', 'value' => "{{ old('CP') }}" ,'maxlength'=> '5','onkeypress'=>'return justNumbers(event);','style' => 'background-color:rgba(230, 238, 250, 0.5);']) !!}
                                <div style="color:#FF0000;">
                                    {{ $errors->first('CP') }}
                                </div>
                            </div>
                    ...
                    <fieldset>
                        ...
                        <div class="form-row col-lg-12">
                            <div class="form-group col-md-4">
                                ...
                                {!! Form::select('tipo_denuncia',$tipo_denuncia,0, ['class' => 'form-control','value' => "{{ old('tipo_denuncia') }}" ,'placeholder' => 'Seleccione una opción', 'style' => 'background-color:rgba(230, 238, 250, 0.5);']) !!}
                                <div style="color:#FF0000;">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                {!! Form::select('delito', $delitos, 0, ['class' => 'form-control','value' => "{{ old('delito') }}" , 'placeholder' => 'Seleccione un delito', 'style' => 'background-color:rgba(230, 238, 250, 0.5);']) !!}
                                <div style="color:#FF0000;">
                                    {{ $errors->first('delito') }}
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                {!! Form::select('fecha_hechos', ['1' => 'Fecha Exacta', '2' => 'Entre Fechas'], 0, ['class' => 'form-control','value' => "{{ old('fecha_hechos') }}" , 'placeholder' => 'Seleccione un tipo', 'style' => 'background-color:rgba(230, 238, 250, 0.5);']) !!}
                                <div style="color:#FF0000;">
                        ...
                        <div class="form-row col-lg-12" id = "entre_fechas">
                            <div class="form-group col-md-3">
                                ...
                                {!! Form::date('fecha_inicio','', ['class' => 'form-control', 'value' => "{{ old('fecha_inicio') }}" ,'style' => 'background-color:rgba(230, 238, 250, 0.5);']) !!}
                                <div style="color:#FF0000;">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                {!! Form::time('hora_inicio', '', ['class' => 'form-control','value' => "{{ old('hora_inicio') }}" , 'style' => 'background-color:rgba(230, 238, 250, 0.5);']) !!}
                                <div style="color:#FF0000;">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                {!! Form::date('fecha_fin',  '', ['class' => 'form-control','value' => "{{ old('fecha_fin') }}" , 'style' => 'background-color:rgba(230, 238, 250, 0.5);']) !!}
                                <div style="color:#FF0000;">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                {!! Form::time('hora_fin', '', ['class' => 'form-control', 'value' => "{{ old('hora_fin') }}" ,'style' => 'background-color:rgba(230, 238, 250, 0.5);']) !!}
                                <div style="color:#FF0000;">
                        ...
                        <div class="form-row col-lg-12" id = "fecha_exacta_div">
                            <div class="form-group col-md-3">
                                ...
                                {!! Form::date('fecha_exacta','', ['class' => 'form-control','value' => "{{ old('fecha_exacta') }}" , 'style' => 'background-color:rgba(230, 238, 250, 0.5);']) !!}
                                <div style="color:#FF0000;">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                {!! Form::time('hora_exacta', '', ['class' => 'form-control','value' => "{{ old('hora_exacta') }}" , 'style' => 'background-color:rgba(230, 238, 250, 0.5);']) !!}
                                <div style="color:#FF0000;">
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            {!! Form::textarea('narrativa', null, ['class' => 'form-control','value' => "{{ old('narrativa') }}" , 'maxlength'=> '4000','placeholder' => 'Recuerda que en la narrativa debes dar una descripción de los  hechos ocurridos.', 'rows' => '7', 'style' => 'background-color:rgba(230, 238, 250, 0.5);'])  !!}
                            <div style="color:#FF0000;">
