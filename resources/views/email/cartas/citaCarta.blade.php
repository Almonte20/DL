            ...
            <td width="100%" style="height: 950px ; width: 100%; background-color:#F8F7F0;color:#58585A;background:url({{asset('http://www.declara.fiscaliamichoacan.gob.mx/img/mail/correo_vertical.png')}}); background-size: cover; background-repeat: no-repeat;">
                ...
                <div style="width:100%;height:200px;">
                  <center style="font-family:Arial; font-size: 12px;">
                    ...
                    <p class="justificar_texto"><b>Lugar:</b> {{ $data->region }}</p>
                    <p class="justificar_texto"><b>Calle:</b> {{ $data->calle.' #'.$data->num_ext }}</p>
                    <p class="justificar_texto"><b>Colonia:</b> {{ $data->colonia }}</p>
                    <p class="justificar_texto"><b>CP:</b> {{ $data->cp }}</p>
                    <p class="justificar_texto"><b>Teléfono:</b> {{ $data->telefono }}</p>
                    <p class="justificar_texto"><b>Cita:</b> {{ $data->fechaCita }} a las {{ substr($data->horaCita, 0, 5) }} Hrs.</p>

                    @if ( $data->email == 'sistemas.ingresos@gmail.com')
                    <p class="justificar_texto"><b>Recuerda que la vigencia de tu Carta de No Antecedentes empieza a partir de la fecha de cita.</b></p>                        
                    @endif
                  </center>
                 </div>
               </td>
